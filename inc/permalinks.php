...
class Kre_SetPermalinks {
	...
	public function add_contextual_permalink_help() {
		...
		$content = '<p>' . __( 'Kre is a different kind of theme, which means it needs to handle URLs differently than other themes. There is no permalink customization in Kre, you need to use the "Month and name" setting for posts.', 'kre' ) . '</p>';
		$content .= '<p>' . __( 'Other content on your site also needs different URLs, like the following:', 'kre' ) . '<ul>';
		$content .= '<li>' . __( 'Pages are now prefixed with <code>page</code>; for example, <code>%1$s/page/about/</code>', 'kre' ) . '</li>';
		$content .= '<li>' . __( 'Date archives are now prefixed with <code>date</code>; for example, <code>%1$s/date/2016/12/</code>', 'kre' ) . '</li>';
		$content .= '<li>' . __( 'Category and tag archives are prefixed with <code>category</code> and <code>tag</code>, which is core behavior, but this cannot be changed.', 'kre' ) . '</li>';
		$content .= '</ul></p>';
		$screen->add_help_tab( array(
			'id'      => 'kre_permalinks_help',
			'title'   => __( 'Kre Permalinks', 'kre' ),
